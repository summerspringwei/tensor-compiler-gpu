...
__global__ void fused_sqq_bert_pipelined(const half *__restrict__ qkv_weight, 
...
//     };
//     // Note attn fc occupies [0, 27KB], [36, 63KB], we use [64, 91KB]
//     half *matrix_a_shared[kStage];
//     const size_t attn_value_shared_mem_offset = 32*1024;
//     matrix_a_shared[0] = all_shared_mem + attn_value_shared_mem_offset;
//     matrix_a_shared[1] =
//         all_shared_mem + attn_value_shared_mem_offset +
//         kChunkK * kWmmaK * (kBlockRowTiles * kWmmaM + kInputSkew);
//     matrix_a_shared[2] =
//         all_shared_mem + attn_value_shared_mem_offset +
//         2 * kChunkK * kWmmaK * (kBlockRowTiles * kWmmaM + kInputSkew);
...
// // Wait for attn_fc stage 1
// pipe.consumer_wait();
// pipe.consumer_release();
// // Wait for attn_fc weight stage 0
// pipe.consumer_wait();
// __syncthreads();
// pipe.consumer_release();
...
#pragma unroll
  ...
  // Begin of Load feed_forward_fc1_weight
  if(blockIdx.x < 96){
...
// End of Load feed_forward_fc1_weight
...
//         pipe.producer_commit();
//     }
// // Wait for Load feed_forward_fc1 weight
