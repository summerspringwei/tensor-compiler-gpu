...
__global__ void gemm_k2(const half *__restrict__ matrix_a,
                        ...
                        half *__restrict__ matrix_c) {
    using namespace nvcuda;
    using namespace souffle::gpt2::AttnQueryKeyParams;
    enum {
...
__global__ void gemm_k2_limited_blocks(const half *__restrict__ matrix_a,
                        const half *__restrict__ matrix_b,
                        half *__restrict__ matrix_c) {
    using namespace nvcuda;
...
__global__ void gemm_k2_limited_blocks_div_softmax(const half *__restrict__ matrix_a,
                        const half *__restrict__ matrix_b,
                        float* softmax_sum, half *__restrict__ matrix_c) {
    using namespace nvcuda;
    using namespace souffle::gpt2::AttnQueryKeyParamsLimitedBlocks;
    enum {
        kBlockRowTiles = kBlockRowWarps * kGemmK2WarpRowTiles,
