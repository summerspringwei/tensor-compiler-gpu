...
int main() {
  ...
  float* d_input = NULL, *d_pw_weight = NULL, *d_dw_weight=NULL, *d_intermedia_output=NULL, *d_output = NULL;
  ...
  init_conv_conv_fusion_data(input, pw_weight, dw_weight, \
    output, height, width, 1, 1, in_channel, out_channel, 1, 1, out_channel, in_channel);
  ...
  depthwise_56_56_144_s11<<<dim3(504,1,1), dim3(128,1,1)>>>(d_intermedia_output, d_dw_weight, d_output);
