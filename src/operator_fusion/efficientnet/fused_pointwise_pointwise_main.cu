...
void init_inputs_and_weights(float* input, float* weight1, float* bias1, float* weight2, float* bias2,
  ...
  // init_values<float>(input, {height, width, in_channels}, 1, 1);
  // init_values<float>(weight1, {in_channels, out_channels_1}, 1, 1);
  // init_values<float>(bias1, {out_channels_1}, 1);
  // init_values<float>(weight2, {out_channels_1, out_channels_2}, 1, 1);
  // init_values<float>(bias2, {out_channels_2}, 1);
  init_values<float>(input, {height, width, in_channels}, 1);
  init_values<float>(weight1, {in_channels, out_channels_1}, 1);
  init_values<float>(bias1, {out_channels_1}, 1);
  init_values<float>(weight2, {out_channels_1, out_channels_2}, 1);
  init_values<float>(bias2, {out_channels_2}, 1);
}
