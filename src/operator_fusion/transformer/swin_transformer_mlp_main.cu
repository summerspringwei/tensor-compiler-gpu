...
#define FUNC_TVM_V3 cudaLaunchCooperativeKernel((void*)fc2_16_16_2048_512_tvm_v3, dim3(8, 8, 1), dim3(32, 1, 4), encoder_kernelArgs, 56*1024);
...
int main(){
  ...
  cudaFuncSetAttribute((void*)fc2_16_16_2048_512_tvm_v3, cudaFuncAttributeMaxDynamicSharedMemorySize, 56*1024);
